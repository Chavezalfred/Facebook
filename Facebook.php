...
<body>
	<table width="100%">
		...
		<td> &emsp; &nbsp; &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <b>facebook</b>
			...
			<div >
				<img class="img-read" src="read.jpg"><p class="text-read"><b>See photos and updates</b>&nbsp; form friends in News Feed.</p>
				<img class="img-timeline" src="timeline.jpg"><p class="text-timeline"><b>Share what's new</b>&nbsp; in your life in Timeline.</p>
				<img class="img-search" src="search.jpg"><p class="text-search"><b>Find more</b>&nbsp; of what you are looking for with Facebook Search.</p>
			</div>
...
<table class="T1">
	...
	<table class="T1">
		...
		<div class="Birth"> <br><b>&nbsp;Birhthday</b></div>
		<tr>
			<td >	
		<div class="Month"> 
		<select name="Month">
